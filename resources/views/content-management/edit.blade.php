        ...
        <div class="col-md-10 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{route('content-management.update',["id"=>$content->id])}}">
                        ...
                        <div class="form-group{{ $errors->has('menu') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="menu_id">
                                    ...
                                    <option {{$menu->id==$content->menu_id?"selected":""}}  value="{{$menu->id}}" >{{$menu->name}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('menu'))
                       ...
                       <div class="form-group{{ $errors->has('heading') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="heading" value="{{$content->heading}}" type="text" class="form-control" name="heading"  required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('copyrights_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="picture_description" type="type" class="form-control" name="picture_description" value="{{ $content->picture_description }}"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('copyrights') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="copyrights" type="text" class="form-control" name="copyrights" value="{{  $content->copyrights }}" >
                        ...
                        <div class="form-group{{ $errors->has('metaTitle') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="metaTitle" type="text" class="form-control" name="metaTitle" value="{{ $content->metaTitle }}" >
                        ...
                        <div class="form-group{{ $errors->has('metaDescription') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9 col-md-offset-3">
                                <textarea id="metaDescription" type="metaDescription" class="form-control" name="metaDescription">{{ $content->metaDescription }}</textarea>
                 ...
                 <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                            ...
                            <div class="clearfix"></div>
                            <div class="col-md-9 col-md-offset-3">
                                <textarea id="details" class="form-control" name="content">{{ $content->content}}</textarea>
                       ...
                       <div class="form-group{{ $errors->has('keywords') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="keywords" type="text" class="form-control" name="keywords" value="{{ $content->keywords  }}" >
