        ...
        <div class="col-md-10 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('advantage-management.update',['id'=>$advantage->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $advantage->name }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('package_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="package_id" type="text" class="form-control" name="package_id" value="{{ $advantage->package_id }}" required autofocus>
                            ...
                            <div class="col-md-6">
                                <input id="comes_with" type="text" class="form-control" name="comes_with" value="{{ $advantage->comes_with }}" required autofocus>
                          ...
                          <div class="form-group{{ $errors->has('importance') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="importance" type="text" class="form-control" name="importance" value="{{ $advantage->importance }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('picture') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="picture" type="file" class="form-control" name="picture" value="{{ $advantage->picture }}" >
                          ...
                          <div class="form-group{{ $errors->has('picture_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="picture_description" type="picture_description" class="form-control" name="picture_description" value="{{ $advantage->picture_description }}" required>
                        ...
                        <div class="form-group{{ $errors->has('details') ? ' has-error' : '' }}">
                           <div class="row"> <label for="details" style='padding:14px;' class="row col-md-5 text-center control-label">Details</label>
                            ...
                            <div class="col-md-12" style='margin-top:10px;'>
                                <textarea id="details" type="details" class="form-control" name="details">{{$advantage->details}}</textarea>
