        ...
        <div class="col-md-10 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('video-management.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('iframe') ? ' has-error' : '' }}">
                            <div class="row"><center> <label for="iframe" style='padding:14px;' class="row col-md-5 text-center control-label">Details</label>
                                </center></div><hr>
                            <div class="clearfix"></div>
                            <div class="col-md-12">
                                <textarea id="iframe" type="iframe" class="form-control" name="iframe">{{old("name")}}</textarea>
